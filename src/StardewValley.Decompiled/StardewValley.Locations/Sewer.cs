...
public class Sewer : GameLocation
{
	...
	public override void drawAboveAlwaysFrontLayer(SpriteBatch b)
	{
		...
		for (float num = -1000f * Game1.options.zoomLevel + steamPosition.X; num < (float)Game1.graphics.GraphicsDevice.Viewport.Width + 256f; num += 256f)
		{
			for (float num2 = -256f + steamPosition.Y; num2 < (float)(Game1.graphics.GraphicsDevice.Viewport.Height + 128); num2 += 256f)
			{
				b.Draw(steamAnimation, new Vector2(num, num2), new Microsoft.Xna.Framework.Rectangle(0, 0, 64, 64), steamColor * 0.75f, 0f, Vector2.Zero, 4f, SpriteEffects.None, 1f);
			}
		}
	}
