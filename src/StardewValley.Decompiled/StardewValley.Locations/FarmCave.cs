...
public class FarmCave : GameLocation
{
	...
	public override void DayUpdate(int dayOfMonth)
	{
		...
		if (Game1.MasterPlayer.caveChoice.Value == 1)
		{
			while (Game1.random.NextDouble() < 0.66)
			{
				...
				Object @object = ItemRegistry.Create<Object>("(O)" + text);
				@object.IsSpawnedObject = true;
				if (CanItemBePlacedHere(vector))
				{
					setObject(vector, @object);
				}
			}
		}
		UpdateReadyFlag();
	...
	public void setUpMushroomHouse()
	{
		...
		foreach (int num in array)
		{
			...
			{
				Object @object = ItemRegistry.Create<Object>("(BC)128");
				@object.fragility.Value = 2;
				setObject(new Vector2(num2, num), @object);
			}
		}
