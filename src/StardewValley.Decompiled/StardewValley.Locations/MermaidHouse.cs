...
public class MermaidHouse : GameLocation
{
	...
	public void playClamTone(int which, Farmer who)
	{
		if (!(oldStopWatchTime < 68000f))
		{
			...
			Game1.playSound("clam_tone", value);
	...
	public override void drawAboveAlwaysFrontLayer(SpriteBatch b)
	{
		...
		{
			b.Draw(mermaidSprites, new Vector2(i - (int)((float)stopWatch.ElapsedMilliseconds / 6f % 448f), num - num * 3 / 4), new Microsoft.Xna.Framework.Rectangle(144, 32, 112, 48), Color.Lime * blackBGAlpha, 0f, Vector2.Zero, 4f, SpriteEffects.None, 0.001f);
			b.Draw(mermaidSprites, new Vector2((float)(i + 112) - (float)stopWatch.ElapsedMilliseconds / 6f % 448f, (float)num - (float)num / 4f + (float)Math.Sin((float)stopWatch.ElapsedMilliseconds / 1000f) * 64f), new Microsoft.Xna.Framework.Rectangle(177, 0, 16, 16), Color.White * blackBGAlpha, 0f, Vector2.Zero, 4f, SpriteEffects.None, 0.001f);
			b.Draw(mermaidSprites, new Vector2(i + (int)((float)stopWatch.ElapsedMilliseconds / 6f % 448f), num * 2 - num * 3 / 4), new Microsoft.Xna.Framework.Rectangle(144, 32, 112, 48), Color.Cyan * blackBGAlpha, 0f, Vector2.Zero, 4f, SpriteEffects.None, 0.001f);
			b.Draw(mermaidSprites, new Vector2((float)(i + 112) + (float)stopWatch.ElapsedMilliseconds / 6f % 448f, (float)(num * 2) - (float)num / 4f + (float)Math.Sin((float)stopWatch.ElapsedMilliseconds / 1000f + 4f) * 64f), new Microsoft.Xna.Framework.Rectangle(161, 0, 16, 16), Color.White * blackBGAlpha, 0f, Vector2.Zero, 4f, SpriteEffects.FlipHorizontally, 0.001f);
			b.Draw(mermaidSprites, new Vector2(i - (int)((float)stopWatch.ElapsedMilliseconds / 6f % 448f), num * 3 - num * 3 / 4), new Microsoft.Xna.Framework.Rectangle(144, 32, 112, 48), Color.Orange * blackBGAlpha, 0f, Vector2.Zero, 4f, SpriteEffects.None, 0.001f);
			b.Draw(mermaidSprites, new Vector2((float)(i + 112) - (float)stopWatch.ElapsedMilliseconds / 6f % 448f, (float)(num * 3) - (float)num / 4f + (float)Math.Sin((float)stopWatch.ElapsedMilliseconds / 1000f + 3f) * 64f), new Microsoft.Xna.Framework.Rectangle(129, 0, 16, 16), Color.White * blackBGAlpha, 0f, Vector2.Zero, 4f, SpriteEffects.None, 0.001f);
			b.Draw(mermaidSprites, new Vector2(i + (int)((float)stopWatch.ElapsedMilliseconds / 6f % 448f), num * 4 - num * 3 / 4), new Microsoft.Xna.Framework.Rectangle(144, 32, 112, 48), Color.HotPink * blackBGAlpha, 0f, Vector2.Zero, 4f, SpriteEffects.None, 0.001f);
			b.Draw(mermaidSprites, new Vector2((float)(i + 112) + (float)stopWatch.ElapsedMilliseconds / 6f % 448f, (float)(num * 4) - (float)num / 4f + (float)Math.Sin((float)stopWatch.ElapsedMilliseconds / 1000f + 2f) * 64f), new Microsoft.Xna.Framework.Rectangle(145, 0, 16, 16), Color.White * blackBGAlpha, 0f, Vector2.Zero, 4f, SpriteEffects.FlipHorizontally, 0.001f);
		}
		...
		foreach (Vector2 bubble in bubbles)
		{
			b.Draw(mermaidSprites, bubble + new Vector2((float)Math.Sin((float)stopWatch.ElapsedMilliseconds / 1000f * 4f + bubble.X) * 4f * 6f, 0f), new Microsoft.Xna.Framework.Rectangle(132, 20, 8, 8), Color.White * blackBGAlpha, 0f, Vector2.Zero, 4f, SpriteEffects.None, 0.001f);
		}
	...
	public override void UpdateWhenCurrentLocation(GameTime time)
	{
		...
		{
			if (stopWatch != null && !stopWatch.IsRunning && cue?.Name == "mermaidSong" && cue.IsPaused)
			{
				stopWatch.Start();
			}
		...
		if (Game1.shouldTimePass())
		{
			...
			if (((cue?.Name == "mermaidSong" && cue.IsPlaying) || (Game1.options.musicVolumeLevel <= 0f && Game1.options.ambientVolumeLevel <= 0f)) && !stopWatch.IsRunning)
			{
				stopWatch.Start();
			}
