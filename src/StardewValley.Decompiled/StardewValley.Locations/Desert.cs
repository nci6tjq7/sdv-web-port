...
public class Desert : GameLocation
{
	...
	protected override void resetLocalState()
	{
		...
		bool flag = false;
		if (locationFromName == null || locationFromName.GetLocationContextId() != GetLocationContextId())
		{
			warpedToDesert = true;
	...
	public override void UpdateWhenCurrentLocation(GameTime time)
	{
		...
		if (IsTravelingDesertMerchantHere())
		{
			...
			{
				chimneyTimer = 500;
				Vector2 position = new Vector2(670f, 308f) * 4f;
				temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Microsoft.Xna.Framework.Rectangle(372, 1956, 10, 10), position, flipped: false, 0.002f, new Color(255, 222, 198))
				{
					alpha = 0.05f,
					alphaFade = -0.01f,
