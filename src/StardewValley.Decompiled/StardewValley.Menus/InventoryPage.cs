...
public class InventoryPage : IClickableMenu
{
	...
	public override void receiveLeftClick(int x, int y, bool playSound = true)
	{
		foreach (ClickableComponent equipmentIcon in equipmentIcons)
		{
			...
			Item item2 = Utility.PerformSpecialItemPlaceReplacement(Game1.player.CursorSlotItem);
			bool flag = item2 == null;
			switch (equipmentIcon.name)
			{
			case "Hat":
				if (item2 == null || item2 is Hat)
				{
					Item heldItem2 = Utility.PerformSpecialItemGrabReplacement(Game1.player.Equip((Hat)item2, Game1.player.hat));
			...
			case "Left Ring":
			case "Right Ring":
				if (item2 == null || item2 is Ring)
				{
					NetRef<Ring> slot = ((equipmentIcon.name == "Left Ring") ? Game1.player.leftRing : Game1.player.rightRing);
					Item heldItem6 = Utility.PerformSpecialItemGrabReplacement(Game1.player.Equip((Ring)item2, slot));
				...
				break;
			case "Boots":
				if (item2 == null || item2 is Boots)
				{
					Item heldItem3 = Utility.PerformSpecialItemGrabReplacement(Game1.player.Equip((Boots)item2, Game1.player.boots));
			...
			case "Shirt":
			{
				if (item2 != null)
				{
					Clothing obj2 = item2 as Clothing;
					if (obj2 == null || obj2.clothesType.Value != 0)
					{
						break;
					}
				}
				Item heldItem5 = Utility.PerformSpecialItemGrabReplacement(Game1.player.Equip((Clothing)item2, Game1.player.shirtItem));
			...
			case "Pants":
			{
				if (item2 != null)
				{
					Clothing obj = item2 as Clothing;
					if (obj == null || obj.clothesType.Value != Clothing.ClothesType.PANTS)
					{
						break;
					}
				}
				Item heldItem4 = Utility.PerformSpecialItemGrabReplacement(Game1.player.Equip((Clothing)item2, Game1.player.pantsItem));
		...
		else if (checkHeldItem() && Game1.oldKBState.IsKeyDown(Keys.LeftShift))
		{
			...
			else if (checkHeldItem((Item i) => i is Clothing clothing2 && clothing2.clothesType.Value == Clothing.ClothesType.SHIRT))
			{
				if (Game1.player.shirtItem.Value == null)
				{
			...
			else if (checkHeldItem((Item i) => i is Clothing clothing && clothing.clothesType.Value == Clothing.ClothesType.PANTS))
			{
				if (Game1.player.pantsItem.Value == null)
				{
