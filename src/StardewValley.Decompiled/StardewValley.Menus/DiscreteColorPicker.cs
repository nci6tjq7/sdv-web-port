...
public class DiscreteColorPicker : IClickableMenu
{
	...
	public override void receiveLeftClick(int x, int y, bool playSound = true)
	{
		...
		Rectangle rectangle = new Rectangle(xPositionOnScreen + IClickableMenu.borderWidth / 2, yPositionOnScreen + IClickableMenu.borderWidth / 2, 36 * totalColors, 28);
		if (rectangle.Contains(x, y))
		{
			colorSelection = (x - rectangle.X) / 36;
			try
			{
