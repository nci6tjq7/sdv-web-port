...
public class ChooseFromListMenu : IClickableMenu
{
	...
	public override void draw(SpriteBatch b)
	{
		...
		int num = (int)Game1.dialogueFont.MeasureString(isJukebox ? text : options[index]).X;
		IClickableMenu.drawTextureBox(b, xPositionOnScreen + width / 2 - num / 2 - 16, yPositionOnScreen + 64 - 4, num + 32, 80, Color.White);
