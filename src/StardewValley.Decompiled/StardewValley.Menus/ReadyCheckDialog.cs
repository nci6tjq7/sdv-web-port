...
public class ReadyCheckDialog : ConfirmationDialog
{
	...
	{
		int numberReady = Game1.netReady.GetNumberReady(checkName);
		int numberRequired = Game1.netReady.GetNumberRequired(checkName);
		message = Game1.content.LoadString("Strings\\UI:ReadyCheck", numberReady, numberRequired);
	}
