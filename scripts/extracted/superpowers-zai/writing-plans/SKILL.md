...
The plan document reviewer prompt template is available at [`plan-document-reviewer-prompt.md`](./plan-document-reviewer-prompt.md) for dispatching a review subagent to evaluate plan quality before execution.
