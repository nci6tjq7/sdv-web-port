...
**Form filling**: See **FORMS.md** (reference unavailable) for complete guide
**API reference**: See **REFERENCE.md** (reference unavailable) for all methods
**Examples**: See **EXAMPLES.md** (reference unavailable) for common patterns
````
...
**Finance**: Revenue, ARR, billing → See **reference/finance.md** (reference unavailable)
**Sales**: Opportunities, pipeline, accounts → See **reference/sales.md** (reference unavailable)
**Product**: API usage, features, adoption → See **reference/product.md** (reference unavailable)
**Marketing**: Campaigns, attribution, email → See **reference/marketing.md** (reference unavailable)
...
Use docx-js for new documents. See **DOCX-JS.md** (reference unavailable).

## Editing documents

For simple edits, modify the XML directly.

**For tracked changes**: See **REDLINING.md** (reference unavailable)
**For OOXML details**: See **OOXML.md** (reference unavailable)
```
...
```markdown  theme={null}
# SKILL.md
See **advanced.md** (reference unavailable)...

# advanced.md
See **details.md** (reference unavailable)...
...
**Advanced features**: See **advanced.md** (reference unavailable)
**API reference**: See **reference.md** (reference unavailable)
**Examples**: See **examples.md** (reference unavailable)
```
