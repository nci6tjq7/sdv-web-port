...
**Dispatch (z.ai Task tool — three calls in one message for parallel execution):**
```
Task(description: "Fix agent-tool-abort.test.ts", prompt: "...", subagent_type: "general-purpose")
Task(description: "Fix batch-completion-behavior.test.ts", prompt: "...", subagent_type: "general-purpose")
Task(description: "Fix tool-approval-race-conditions.test.ts", prompt: "...", subagent_type: "general-purpose")
```
